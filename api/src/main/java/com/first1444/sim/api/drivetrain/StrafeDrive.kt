...
interface StrafeDrive : Drivetrain {
     ...
     * @param forward A positive value makes the robot move in the positive X direction, a negative value in the negative X direction
     * @param strafe A positive value makes the robot move in the negative Y direction, a negative value in the positive Y direction
