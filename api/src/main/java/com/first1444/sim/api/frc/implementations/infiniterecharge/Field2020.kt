...
object Field2020 {
    ...
    val ALLIANCE_POWER_CELL_STARTING: List<Vector2> = listOf(
            ...
            Vector2(WIDTH / 2 - inchesToMeters(94.66 + 81.14), LENGTH / 2 - inchesToMeters(130 + 120.51)), // center left
            Vector2(WIDTH / 2 - inchesToMeters(94.66 + 65.84), LENGTH / 2 - inchesToMeters(130 + 114.17)), // center middle
            Vector2(WIDTH / 2 - inchesToMeters(94.66 + 50.54), LENGTH / 2 - inchesToMeters(130 + 107.83)), // center right

            Vector2(WIDTH / 2 - inchesToMeters(94.66 + 26.13), LENGTH / 2 - inchesToMeters(130 + 114.94)), // right left
            Vector2(WIDTH / 2 - inchesToMeters(94.66 + 19.79), LENGTH / 2 - inchesToMeters(130 + 130.25)) // right right
    )
